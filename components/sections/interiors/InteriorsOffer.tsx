...
const offers = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1760072513376-67a46aab0fd1?q=80&w=2070&auto=format&fit=crop",
  },
  {
      ...
      <div className="container mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
          ...
          <h2 className="text-3xl md:text-5xl font-display font-bold text-primary mb-6">
            End-to-End{" "}
            <span className="text-primary/70">Interior Solutions</span>
          </h2>
          <p className="text-slate-600 text-lg">
            We handle everything from conceptualization to the final touch,
            ensuring your home reflects your personality.
          </p>
        </div>
